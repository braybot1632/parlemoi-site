...
<template>
  <section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
      ...
      <!-- Store buttons with Coming Soon overlay -->
      <div
      ...
      >
        <div class="relative">
          <div class="inline-flex items-center gap-2.5 text-white/30 font-medium px-7 py-3.5 rounded-full text-sm border border-white/10 select-none">
          ...
          <div class="absolute inset-0 flex items-center justify-center rounded-full bg-darkest/70 backdrop-blur-sm">
            <span class="text-xs font-medium text-orange uppercase tracking-wider">Coming Soon</span>
          </div>
        </div>
        <div class="relative">
          <div class="inline-flex items-center gap-2.5 text-white/30 font-medium px-7 py-3.5 rounded-full text-sm border border-white/10 select-none">
