...
<template>
  <section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 pt-20 pb-20 md:pt-24 text-center">
      <!-- Headline -->
      <h1
      ...
      <!-- Beta signup form -->
      <div
        class="mt-8 md:mt-16 max-w-md mx-auto transition-all duration-1000 delay-400"
        :class="visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'"
      >
      ...
      >
        <div class="flex flex-wrap items-center justify-center gap-3 text-xs text-text-muted">
          <div class="inline-flex items-center gap-2 rounded-full border border-card-border/70 bg-white/60 px-3.5 py-2">
            ...
            <span class="text-orange font-medium">soon</span>
          </div>
          <div class="inline-flex items-center gap-2 rounded-full border border-card-border/70 bg-white/60 px-3.5 py-2">
