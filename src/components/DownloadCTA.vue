...
<template>
  <section id="download" class="section-pad relative overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-6 text-center">
      <div class="reveal">
        <h2 class="font-display text-3xl md:text-5xl font-bold text-text-dark" style="letter-spacing: -0.02em; line-height: 1.1;">
          Be the first to try it.
        </h2>
        <p class="mt-5 text-lg text-text-secondary max-w-md mx-auto">
