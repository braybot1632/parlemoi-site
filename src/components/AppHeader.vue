...
<template>
  ...
  >
    <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      >
        <span class="block w-5 h-0.5 bg-cream transition-all duration-300" :class="{ 'rotate-45 translate-y-2': menuOpen }"></span>
        <span class="block w-5 h-0.5 bg-cream transition-all duration-300" :class="{ 'opacity-0': menuOpen }"></span>
        <span class="block w-5 h-0.5 bg-cream transition-all duration-300" :class="{ '-rotate-45 -translate-y-2': menuOpen }"></span>
      </button>
    </div>
